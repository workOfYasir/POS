...
<div class="text-center">
    <h1 class="font-weight-bold">Samurai Pos Installation</h1>
    ...
    <ul class="list-group">
        <li class="list-group-item">
            <h6 class="font-weight-normal">
                <i class="fas fa-check"></i> Database Host Name</h6>
        </li>
        <li class="list-group-item">
            <h6 class="font-weight-normal">
                <i class="fas fa-check"></i> Database Name</h6>
        </li>
        <li class="list-group-item">
            <h6 class="font-weight-normal">
                <i class="fas fa-check"></i> Database User Name</h6>
        </li>
        <li class="list-group-item">
            <h6 class="font-weight-normal">
                <i class="fas fa-check"></i> Database Password</h6>
        </li>
    </ul>
</div>
