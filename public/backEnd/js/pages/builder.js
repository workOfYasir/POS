...
var KTLayoutBuilder = function() {
	...
	var exporter = {
		init: function() {
			$('#kt-btn-howto').on('click',function(e) {
				e.preventDefault();
	...
	var preview = function() {
		$('[name="builder_submit"]').on('click',function(e) {
			e.preventDefault();
			var _self = $(this);
			$(_self).
			addClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').
	...
	var reset = function() {
		$('[name="builder_reset"]').on('click',function(e) {
			e.preventDefault();
			var _self = $(this);
			$(_self).
			addClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').
	...
	var keepActiveTab = function() {
		$('[href^="#kt_builder_"]').on('click',function(e) {
	...
	var verify = {
		...
		init: function() {
			...
			// click event
			$('#builder_export').on('click',function(e) {
				e.preventDefault();
			...
			$('#submit-verify').on('click',function(e) {
				e.preventDefault();
