...
var KTIdleTimerDemo = function() {
    ...
    var demo2 = function() {
        ...
        */
        ...
        $("#btLastActive").on('click',function() {
            $('#elStatus')
                .val(function(i, v) {
