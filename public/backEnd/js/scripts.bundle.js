	...
	$.fn[pluginName].checkbox = function(datatable, options) {
		var Extension = {
			...
			initEvent: function() {
				...
				$(datatable.tableHead).find('.' + pfx + 'checkbox--all > [type="checkbox"]').on('click',function(e) {
				...
				$(datatable.tableBody).find('.' + pfx + 'checkbox--single > [type="checkbox"]').on('click',function(e) {
					var id = $(this).val();
					if ($(this).is(':checked')) {
						Extension.selectedRows.push(id);
						// remove from unselected rows
